...
export const What: React.FC<Props> = ({ glossary, projects }) => (
  <>
    <Helmet>
      <title>{`${glossary.author} · projects`}</title>
      <meta property="og:title" content={`${glossary.author} · projects`} />
      <meta property="twitter:title" content={`${glossary.author} · projects`} />
    </Helmet>
    <div className="What">
